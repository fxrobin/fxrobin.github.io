...
natives qui sont offertes par JPA pour déclarer des `NamedQuery`. On verra alors que ces deux solutions ont des défauts et je vous proposerai alors une **3ème solution qui me parait plus satisfaisante, fondée sur une "enum"**.
